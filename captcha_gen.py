...
class Captcha:
    def __init__(self):
        ...
        self.login_url = 'http://219.231.8.121/Home/Web/area?area=7&segment=' + '17301' + '&day=' + self.day_time + '&startTime=07:00&endTime=22:00'
    ...
    def image_process(self, filename):
        self.driver.get_screenshot_as_file('./project/Subscribe/' + filename)
        img = Image.open('./project/Subscribe/' + filename)
        box = (659, 380, 738, 428)
        image = img.crop(box)
        image.save('./project/Subscribe/verify_' + filename)
        self.shutdown()
