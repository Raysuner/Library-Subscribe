...
@LastEditTime: 2019-05-07 20:26:26
'''
import os
    ...
    for file in files:
        ...
        for subbox in boxs:
            ...
            if width >= 15:
                ...
                img1.save(train_dir + str(cnt) + '.png')
                cnt += 1
                img2 = img.crop((mid, 0, width, 48))
                img2.save(train_dir + str(cnt) + '.png')
                cnt += 1
            else:
                img.save(train_dir + str(cnt) + '.png')
                cnt += 1


if __name__ == '__main__':
    captcha_dir = './project/Subscribe/dataset/images/'
    train_dir = './project/Subscribe/train/'
    capt_process(captcha_dir, train_dir)